...
public interface calculoCientificoToCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link calculoCientificoToCParser#sent_tail}.
	 * @param ctx the parse tree
	 */
	void enterSent_tail(calculoCientificoToCParser.Sent_tailContext ctx);
	/**
	 * Exit a parse tree produced by {@link calculoCientificoToCParser#sent_tail}.
	 * @param ctx the parse tree
	 */
	void exitSent_tail(calculoCientificoToCParser.Sent_tailContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link calculoCientificoToCParser#op}.
	 * @param ctx the parse tree
	 */
	void enterOp(calculoCientificoToCParser.OpContext ctx);
	/**
	 * Exit a parse tree produced by {@link calculoCientificoToCParser#op}.
	 * @param ctx the parse tree
	 */
	void exitOp(calculoCientificoToCParser.OpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link calculoCientificoToCParser#factor_tail}.
	 * @param ctx the parse tree
	 */
	void enterFactor_tail(calculoCientificoToCParser.Factor_tailContext ctx);
	/**
	 * Exit a parse tree produced by {@link calculoCientificoToCParser#factor_tail}.
	 * @param ctx the parse tree
	 */
	void exitFactor_tail(calculoCientificoToCParser.Factor_tailContext ctx);
	/**
